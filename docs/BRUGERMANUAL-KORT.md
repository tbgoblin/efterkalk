...
- VIA viser den aktuelle åbne produktion, uafhængigt af fakturaperioden. `Overskredet levering` kræver en kendt leveringsdato før i dag; ressourcer viser kapitalbinding ved næste ressource, ikke kapacitetsbelastning i timer.
